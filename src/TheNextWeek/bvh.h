...
class bvh_node : public hittable {
 public:
  bvh_node(hittable_list list)
    ...
    // creates an
    // implicit copy of the hittable list, which we will modify. The lifetime of
    // the copied list only extends until this constructor exits. That's OK,
    // because we only need to persist the resulting bounding volume hierarchy.
  }
